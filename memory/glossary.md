...
| **planes mensuales (opcionales)** | No à la carte add-ons anymore: all paid extras live inside two optional monthly plans (after the included first month, no contract, cancel anytime, both include hosting). **Plan de presencia $50.000 COP/mes**: hosting + Ficha de Google activa y actualizada + versión bilingüe ES/EN + soporte WhatsApp + hasta 2 cambios al mes. **Plan de ventas $150.000 COP/mes**: todo lo de Presencia + asistente de ventas 24/7 (chatbot que conoce el negocio, responde, pasa al WhatsApp con un clic y agenda llamadas) + vitrina de hasta 30 productos + catálogo o menú descargable + reporte mensual de actividad. The base page already includes the Ficha de Google (NOT an add-on). |
| **ronda de revisión adicional** | $90.000 COP. A per-revision charge beyond the 2 included rounds, NOT an add-on. |
