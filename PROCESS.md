...
> ⚠ **OUTDATED · superseded by the single-product model (2026-05).** This document still describes the retired two-tier Esencial/Crecimiento funnel and its tier-gated pricing/process. The CURRENT offer is: ONE product, "La página de ventas" $400.000 COP (incluye la Ficha de Google), with NO à la carte add-ons. The former add-ons (vitrina de productos, catálogo o menú descargable, versión bilingüe) and the 24/7 assistant are folded into the optional monthly plans: Plan de presencia $50.000/mes (hosting + Ficha activa + versión bilingüe + soporte WhatsApp + hasta 2 cambios) and Plan de ventas $150.000/mes (todo lo de Presencia + asistente 24/7 + vitrina hasta 30 + catálogo descargable + reporte mensual). Standalone hosting $30.000/mes. No Esencial/Pro/Crecimiento tiers. Source of truth for the offer: `CLAUDE.md`. Treat the tier-specific steps below as historical reference only until this doc is rewritten.
...
| Marketing email forwarding | Cloudflare Email Routing | `hello@pymewebpro.com` → personal inbox |
