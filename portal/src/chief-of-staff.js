...
2. **PymeWebPro** (DBA de Norte Sur Consulting S.A.S., NIT 901.956.771-1) · estudio de diseño web colombiano para PYMEs colombianas. SOLO mercado colombiano, SOLO precios en COP. UN producto: "La página de ventas" $400.000 COP (IVA incluido, incluye la Ficha de Google + 1 mes del plan mensual). NO hay add-ons à la carte: todos los extras pagos viven dentro de UN plan mensual opcional (incluye hosting, sin contrato, cancela cuando quieras): Plan mensual $150.000/mes, todo incluido (hosting + Ficha de Google activa y actualizada + versión bilingüe ES/EN + soporte WhatsApp + hasta 2 cambios al mes + asistente de ventas 24/7 que conoce el negocio, responde, pasa al WhatsApp y agenda llamadas + vitrina de hasta 30 productos + catálogo o menú descargable + reporte mensual). Sin planes Esencial/Pro. Pagos vía Wompi.
