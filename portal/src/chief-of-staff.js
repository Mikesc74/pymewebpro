...
2. **PymeWebPro** (DBA de Norte Sur Consulting S.A.S., NIT 901.956.771-1) · estudio de diseño web colombiano para PYMEs colombianas. SOLO mercado colombiano, SOLO precios en COP. UN producto: "La página de ventas" $400.000 COP (IVA incluido, incluye la Ficha de Google), más 3 add-ons à la carte a $75.000 c/u (vitrina de productos, catálogo o menú descargable en PDF, versión bilingüe). Planes mensuales opcionales (ambos incluyen hosting): Plan de presencia $50.000/mes, Plan de ventas $150.000/mes (incluye el chatbot, asistente de ventas 24/7). Sin planes Esencial/Pro. Pagos vía Wompi.
