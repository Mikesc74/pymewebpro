...
const PROPOSAL_TEXT_ES = {
  ...
  terms3: "Esta propuesta es válida durante 30 días desde la fecha indicada arriba. Cualquier cambio de alcance posterior se cotiza por separado, o se cubre con un plan mensual o una ronda de revisión adicional.",
...
const PROPOSAL_TEXT_EN = {
  ...
  terms3: "This proposal is valid for 30 days from the date above. Any out-of-scope changes after sign-off are quoted separately, or covered by a monthly plan or an additional revision round.",
