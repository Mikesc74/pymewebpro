...
.price-card .cta-row{margin-top:30px}
...
<header class="header">
  <div class="header-inner">
    ...
    <nav class="nav">
      ...
      <a href="#cta-final" class="cta"><span class="ml-en">Get a Quote</span><span class="ml-es">Cotizar</span> <span class="arrow">→</span></a>
    </nav>
  </div>
</header>
...
<aside class="nav-drawer" id="navDrawer" role="dialog" aria-label="Navigation" aria-modal="true">
  ...
  <div class="nd-foot">
    ...
    <a href="#cta-final" class="cta" data-nav-close><span class="ml-en">Get a Quote</span><span class="ml-es">Cotizar</span> <span class="arrow">→</span></a>
  </div>
</aside>
...
<section class="hero">
  <div class="hero-grid">
    ...
    <div class="hero-cta">
      <a href="#cta-final" class="btn btn-primary"><span class="ml-en">Book a 20-min Call</span><span class="ml-es">Agendar llamada de 20 min</span> <span class="arrow">→</span></a>
      <a href="#portfolio" class="btn btn-outline"><span class="ml-en">See Recent Work</span><span class="ml-es">Ver trabajo reciente</span></a>
    </div>
    <div class="hero-meta">
  ...
  <div class="container">
    ...
    <div class="price-grid">
      <div class="price-card">
        ...
        <div class="price-suffix">one-time · 1 year hosting included</div>
        ...
        <div class="cta-row">
          <a href="#cta-final" class="btn btn-outline">Start with Essential <span class="arrow">→</span></a>
        </div>
      </div>
      ...
      <div class="price-card featured">
        ...
        <div class="price-suffix">one-time · 2 years hosting included</div>
        ...
        <div class="cta-row">
          <a href="#cta-final" class="btn btn-accent">Start with Pro <span class="arrow">→</span></a>
        </div>
      </div>
    </div>
    ...
    <div class="price-foot" style="margin-top:12px">
      ...
      <div><strong>CAD or USD pricing · 50% deposit, 50% on launch.</strong> Pay by credit card, Apple Pay, Google Pay, or direct wire via our Wise Business account. <strong>30-day money-back guarantee</strong> after launch. Hosting included for the first 1–2 years; $15/mo or $180/yr after that.</div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="faq-list">
      ...
      <details class="faq-item">
        ...
        <div class="ans">50% deposit on signing (we don't start design or development until the deposit clears). 50% on launch (we hold the finished site on a staging URL and don't connect your domain until the second payment lands). Both invoices accept credit cards, Apple Pay, Google Pay, or direct wire via our Wise Business account.</div>
      </details>
      <details class="faq-item">
...
<section class="cta-final" id="cta-final">
  <div class="inner">
    <span class="eyebrow"><span class="dot live"></span><span class="ml-en">Now booking · July 2026</span><span class="ml-es">Cupos abiertos · julio 2026</span></span>
    <h2><span class="ml-en">20 minutes. <span class="accent">A free quote.</span> No commitment.</span><span class="ml-es">20 minutos. <span class="accent">Cotización gratis.</span> Sin compromiso.</span></h2>
    <p><span class="ml-en">Book a short call, we'll talk through what you need, give you a hard quote, and tell you honestly if we're the right fit.</span><span class="ml-es">Agende una llamada corta. Hablamos de lo que necesita, le damos cotización por escrito, y le decimos honestamente si encajamos para su proyecto.</span></p>
    <div class="btn-row">
      <a href="#" class="btn btn-accent"><span class="ml-en">Book Discovery Call</span><span class="ml-es">Agendar llamada</span> <span class="arrow">→</span></a>
      <a href="mailto:hello@pymewebpro.com" class="btn btn-outline">Email hello@pymewebpro.com</a>
    </div>
    <div class="meta">
      <div class="item"><svg class="ico" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg>20-min call</div>
      <div class="item"><svg class="ico" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg>Free written quote</div>
      <div class="item"><svg class="ico" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg>No contract until you say go</div>
    </div>
  </div>
</section>
