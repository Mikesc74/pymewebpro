    ...
    <div class="stack-grid">
      <div class="stack-list">
        ...
        <div class="stack-item">
          ...
          <div class="body">
            <h3><span class="ml-en">Hand-coded HTML · No WordPress, no themes</span><span class="ml-es">HTML hecho a mano · Sin WordPress, sin temas</span></h3>
  ...
  <div class="container">
    ...
    <div class="faq-list">
      ...
      <details class="faq-item">
        ...
        <div class="ans"><span class="ml-en">Claude, Anthropic's flagship model, is used through every step of design and build, the same way modern engineering teams use it internally. It replaces the designer and the developer, making the process dramatically faster. The result is a custom-crafted site delivered in 48 hours instead of six weeks. You're not buying AI-generated slop, you're buying senior craft accelerated by serious tooling.</span><span class="ml-es">Claude, el modelo principal de Anthropic, se usa en cada paso del diseño y la construcción, igual que lo usan los equipos de ingeniería modernos. Reemplaza al diseñador y al desarrollador, haciendo el proceso dramáticamente más rápido. El resultado es un sitio hecho a la medida en 48 horas en lugar de seis semanas. No está comprando contenido generado por IA, está comprando trabajo de seniors acelerado por herramientas serias.</span></div>
      </details>
      <details class="faq-item">
