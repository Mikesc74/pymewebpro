...
.locations{max-width:var(--max);margin:24px auto 0;padding:28px var(--gutter);display:grid;grid-template-columns:repeat(2,1fr);gap:30px;border-top:1px solid var(--line);border-bottom:1px solid var(--line)}
  ...
  <div class="container">
    ...
    <div class="price-grid geo-co">
      <div class="price-card">
        ...
        <div class="price-suffix"><span class="ml-en">one-time · 1 year hosting included · $207.000 deposit to start</span><span class="ml-es">pago único · 1 año de hosting incluido · depósito de $207.000 para empezar</span></div>
        <p class="desc"><span class="ml-en">A premium one-page marketing site with everything an SMB actually needs. Perfect for clinics, restaurants, salons, studios, and service businesses.</span><span class="ml-es">Sitio de marketing premium de una página con todo lo que una pyme necesita. Ideal para clínicas, restaurantes, salones, estudios y servicios.</span></p>
        <ul>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg><span class="ml-en">Single-page multi-section custom site</span><span class="ml-es">Sitio de una sola página con múltiples secciones</span></li>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg><span class="ml-en">Cloudflare hosting · 1 year included</span><span class="ml-es">Hosting Cloudflare · 1 año incluido</span></li>
        ...
        <div class="cta-row">
          <a href="https://checkout.wompi.co/l/kNsvyu" target="_blank" rel="noopener" class="btn btn-outline"><span class="ml-en">Pay $207.000 deposit &amp; start</span><span class="ml-es">Pagar depósito $207.000 y empezar</span> <span class="arrow">→</span></a>
          <a href="#cta-final" class="btn btn-link"><span class="ml-en">Or schedule a call →</span><span class="ml-es">O agendar una llamada →</span></a>
        </div>
      </div>
      ...
      <div class="price-card featured">
        ...
        <div class="price-suffix"><span class="ml-en">one-time · 2 years hosting included · $324.000 deposit to start</span><span class="ml-es">pago único · 2 años de hosting incluido · depósito de $324.000 para empezar</span></div>
        <p class="desc"><span class="ml-en">Multi-section site with integrations, bilingual support, advanced forms, and ongoing edits. For brands that need a real digital presence.</span><span class="ml-es">Sitio multi-sección con integraciones, soporte bilingüe, formularios avanzados y ediciones continuas. Para marcas que necesitan presencia digital real.</span></p>
        <ul>
        ...
        <div class="cta-row">
          <a href="https://checkout.wompi.co/l/3tNB1l" target="_blank" rel="noopener" class="btn btn-accent"><span class="ml-en">Pay $324.000 deposit &amp; start</span><span class="ml-es">Pagar depósito $324.000 y empezar</span> <span class="arrow">→</span></a>
          <a href="#cta-final" class="btn btn-link" style="color:rgba(255,255,255,0.75)"><span class="ml-en">Or schedule a call →</span><span class="ml-es">O agendar una llamada →</span></a>
        </div>
      </div>
    </div>
    ...
    <div class="price-foot">
      ...
      <div><strong><span class="ml-en">What an equivalent site would cost from a Toronto agency:</span><span class="ml-es">Lo que costaría un sitio equivalente en una agencia de Toronto:</span></strong> <span class="geo-na ml-en">$5,000–$12,000 CAD with a 6–10 week timeline. Same code, same hosting, same security headers, we just don't have the agency overhead to pass along.</span><span class="geo-na ml-es">$5.000–$12.000 CAD con plazo de 6–10 semanas. Mismo código, mismo hosting, mismos encabezados de seguridad, simplemente no tenemos el sobrecosto de agencia que trasladar.</span><span class="geo-co ml-en">$15.000.000–$36.000.000 COP with a 6–10 week timeline. Same code, same hosting, same security headers, we just don't have the agency overhead to pass along.</span><span class="geo-co ml-es">$15.000.000–$36.000.000 COP con plazo de 6–10 semanas. Mismo código, mismo hosting, mismos encabezados de seguridad, simplemente no tenemos el sobrecosto de agencia que trasladar.</span></div>
    </div>
    ...
    <div class="cmp-grid">
      <div class="cmp-card them">
        ...
        <div class="head">
          ...
          <div class="price-line"><span class="geo-na"><span class="ccy">CAD</span>$5K–$12K</span><span class="geo-co"><span class="ccy">COP</span>$15M–$36M</span></div>
        </div>
        <ul>
      ...
      <div class="cmp-card us">
        <div class="head">
          ...
          <div class="price-line"><span class="geo-na"><span class="ccy">CAD</span>$800</span><span class="geo-co"><span class="ccy">COP</span>$1.080.000</span></div>
        </div>
        <ul>
