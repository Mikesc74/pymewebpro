...
(function () {
  ...
  const EN = {
    ...
    // Accordion + new pricing copy
    'Ver todo lo incluido': 'See everything included',
    '5 páginas:': '5 pages:',
    'Mapa de Google integrado + diseño listo para celular': 'Google Maps embedded + mobile-ready design',
    'SSL/HTTPS incluido + indexado en Google en 7 días': 'SSL/HTTPS included + indexed on Google in 7 days',
    '2 rondas de cambios incluidas': '2 revision rounds included',
    'le devolvemos el dinero si no le gusta': "money back if you don't love it",
    'Barra social: WhatsApp, Instagram, Facebook y Maps en un clic':
      'Social bar: WhatsApp, Instagram, Facebook and Maps in one tap',
    'Galería de fotos para mostrar su negocio': 'Photo gallery to showcase your business',
    'Sección de testimonios o reseñas de clientes': 'Testimonials or customer reviews section',
    'Meta tags optimizadas por página + sitemap automático': 'Optimized meta tags per page + auto sitemap',
    'Carga en menos de 1 segundo': 'Loads in under 1 second',
    'El dominio queda a su nombre, suyo para siempre (registro ~$50k–$150k/año al registrador)':
      'Domain stays in your name, yours forever (registration ~$50k–$150k/year paid to the registrar)',
    '+ Google Analytics, Search Console, sitemap.xml y robots.txt configurados':
      '+ Google Analytics, Search Console, sitemap.xml, and robots.txt configured',
    'Todo lo del plan Esencial': 'Everything in the Essential plan',
    '(valor $360.000 COP)': '(value $360,000 COP)',
    'Blog, galería ampliada, reservas, equipo y FAQ': 'Blog, extended gallery, bookings, team and FAQ',
    'Versión bilingüe (español + inglés)': 'Bilingual version (Spanish + English)',
    'Google Business Profile + logo asistido por IA': 'Google Business Profile + AI-assisted logo',
    '5 rondas de cambios incluidas': '5 revision rounds included',
    'Sistema de agendamiento o reservas integrado': 'Integrated booking or reservation system',
    'PDF descargable (menú, catálogo o ficha técnica)': 'Downloadable PDF (menu, catalog, or spec sheet)',
    'Captura de correos para newsletter o promociones': 'Email capture for newsletter or promotions',
    'Catálogo de WhatsApp Business enlazado': 'Linked WhatsApp Business catalog',
    'Conversion tracking: Meta Pixel + GA4 con metas configuradas': 'Conversion tracking: Meta Pixel + GA4 with goals configured',
    'Formulario de contacto con confirmación automática': 'Contact form with automatic confirmation',
    'Datos estructurados para resultados enriquecidos en Google': 'Structured data for rich results on Google',
    'Optimización de Core Web Vitals (velocidad y rendimiento)': 'Core Web Vitals optimization (speed and performance)',
    'en Cloudflare (99.9% uptime)': 'on Cloudflare (99.9% uptime)',
    'Pequeños cambios cada mes (horarios, fotos, textos, ofertas)':
      'Small monthly changes (hours, photos, copy, offers)',
    'Sin contrato': 'No contract',
    'Protección anti-ataques (DDoS, hackers, bots)': 'Attack protection (DDoS, hackers, bots)',
    'Monitoreo 24/7 + alertas si su sitio cae': '24/7 monitoring + alerts if your site goes down',
    'Backups automáticos diarios': 'Automatic daily backups',
    'Reporte mensual de visitas': 'Monthly traffic report',
    'Carga en menos de 1 segundo desde cualquier ciudad de Colombia':
      'Loads in under 1 second from any city in Colombia',
