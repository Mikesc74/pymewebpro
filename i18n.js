...
(function () {
  ...
  const EN = {
    ...
    'Indexado en Google en 7 días, meta tags optimizadas por página, sitemap automático y carga en menos de 2 segundos':
      'Indexed on Google within 7 days, optimized meta tags per page, automatic sitemap, and page load under 2 seconds',
